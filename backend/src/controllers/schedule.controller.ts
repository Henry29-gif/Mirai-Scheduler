...
export async function generateSchedule(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function getCostSummary(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function getTimesheet(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function publishScheduleHandler(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function getScheduleForMonth(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function reassignShift(req: AuthRequest, res: Response, next: NextFunction) {
  try {
...
export async function moveShift(req: AuthRequest, res: Response, next: NextFunction) {
  try {
